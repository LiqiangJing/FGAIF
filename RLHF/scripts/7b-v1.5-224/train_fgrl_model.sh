...
export MODEL_DIR="/home/lxj220018/LLaVA-RLHF-new/checkpoints"
...
#RM_LORA_OBJ=LLaVA-OBJ-AI-RM-13b-v1.5-336-lora-padding/checkpoint-9060  # we use early stopping
#RM_LORA_ATT=LLaVA-ATT-AI-RM-13b-v1.5-336-lora-padding/checkpoint-9060
#RM_LORA_REL=LLaVA-REL-AI-RM-13b-v1.5-336-lora-padding/checkpoint-9060

RM_LORA_OBJ=LLaVA-OBJ-Atomic-RM-13b-v1.5-336-lora-padding/checkpoint-9555  # we use early stopping
RM_LORA_ATT=LLaVA-ATT-Atomic-RM-13b-v1.5-336-lora-padding/checkpoint-9555
RM_LORA_REL=LLaVA-REL-Atomic-RM-13b-v1.5-336-lora-padding/checkpoint-9555

# SAVE CONFIG
#MODEL_NAME=LLaVA-RL-Fact-RLAIF-7b-v1.5-224-lora-padding
#MODEL_NAME=LLaVA-RL-Fact-RLAIF-7b-v1.5-224-lora-padding
#MODEL_NAME=LLaVA-RL-Fact-RLATFC-7b-v1.5-224-lora-padding-1e-7-15k
#    --dataset_path $DATA_DIR/fg_reward_data.json \
...
KL_COEF=0.1
EPOCH=4
ROLLOUT_BATCH_SIZE=512 #512
STEP_BATCH_SZIE=256 #256
ROLLOUT_PER_DEVICE_BATCH_SIZE=64 #64
REWARD_MODEL_PER_DEVICE_BATCH_SIZE=16 #16
STEP_PER_DEVICE_BATCH_SIZE=16 #16
NOPTEPOCHS=2
...
MODEL_NAME=LLaVA-RL-Fact-RLATFC-7b-v1.5-224-lora-padding-1e-7-15k-without-object

#torchrun \
#    --standalone \
#    --nnodes=1 \
#    --nproc-per-node=$GPUS_PER_NODE \
#    finetune_lora_fg_ppo.py \
#    --do_train \
#    --seed 42 \
...
#    --warmup_steps 5 \
#    --dataset_path $DATA_DIR/fg_train_15k.json \
#    --train_splits "train" \
...
MODEL_NAME=LLaVA-RL-Fact-RLATFC-7b-v1.5-224-lora-padding-1e-7-15k-without-attribute
...
MODEL_NAME=LLaVA-RL-Fact-RLATFC-7b-v1.5-224-lora-padding-1e-7-15k-without-relation
