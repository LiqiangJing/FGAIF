...
from fg_lora_utils import (
    SavePeftModelCallback,
    print_trainable_parameters,
    get_last_checkpoint,
    DEFAULT_PAD_TOKEN,
)
from data_utils.data_utils_fine_rm import make_binary_reward_modeling_data_module
from models.fine_reward_model import (
    RewardConfig,
    RewardModel,
...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    reward_type: int = field(
        default=None,
        metadata={
            "help": "The reward type 0: object 1: attribute 2: relation."
        },
    )
...
def train():
    ...
    print(f"Training the {args.reward_type}-th reward model!")
    ...
    # data_module["train_dataset"][0]["input_ids"][0]
    # exit()
    if args.do_train:
        ...
        for i in range(min(3, len(training_data))):
            ...
            # print("ex_input_ids", ex_input_ids_0)
            ...
            rank0_print("=" * 20)
            ex_input_ids_1 = training_data[i]["input_ids"][0]
