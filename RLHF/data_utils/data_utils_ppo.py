...
class QueryResponseDataset(Dataset):
    ...
    def __init__(
        ...
        # print(_s[1])
        # print(_s[0])
        _s = [__s[:2] for __s in _s] ## select first 2
        # print()
        # print(_s[0])
        # exit(_s[0])
        for __s in _s:
        ...
        # print("queries shape", queries.shape) #[72056, 128]
    ...
    def __getitem__(self, idx):
        ...
        # print(return_dict.keys()) #dict_keys(['queries', 'query_attn_masks', 'images', 'reward_images', 'image_file_ids', 'caption_types', 'length_bonus_multiplier'])
        return return_dict
